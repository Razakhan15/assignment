      ...
      <div className="rounded-lg flex shadow-[rgba(0,0,15,0.3)_5px_5px_4px_0px] py-2 lg:px-5 px-1 lg:gap-5 gap-2">
        ...
        <div className="flex-auto w-3/4">
          <div className="flex gap-5 items-center">
            <h2 className="font-bold text-sm lg:text-lg">Lorem ipsum</h2>
          ...
          <p className="break-words my-2 text-xs lg:text-lg">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. lamanante
            alias sequi deleniti, iure repellat consectetur?
          </p>
